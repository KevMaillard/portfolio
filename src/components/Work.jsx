...
import logoSpot from '../assets/logoSpot.png'
        ...
        <div name='work' className='w-full md:h-screen text-gray-300 bg-[#0a192f]'>
            <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
                ...
                <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
                                    {/* Grid Item */}
                    <div style={{ backgroundImage: `url(${logoSpot})` }} className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'>
                        {/* Hover effect */}
                        <div className='opacity-0 group-hover:opacity-100'>
                            ...
                            <div className='pt-8 text-center'>
                                <a href="https://www.linkedin.com/company/appspot" target="_blank" rel="noopener noreferrer">
